...
public class AppliTestBO {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Combinaison uneCombi = new Combinaison(1, "Bic", "BBOrange", "Bic bille Orange", 1.2f, 20, "Bleu");
			System.out.println("\nREM : Affichage d'un article Stylo 'Bic'");
			System.out.println(uneCombi.toString());
			System.out.println("---------------------------------------------------------------");
			Ski uneSki = new Ski(2, "Clairef", "CRA4S", "Ramette A4 Sup", 9f, 20, 80);
			System.out.println("\nREM : Affichage d'un article Ramette 'Clairefontaine'");
			System.out.println(uneSki.toString());
			System.out.println("---------------------------------------------------------------");

			// Ajout des articles à la liste.
			articles.add(uneCombi);
			articles.add(uneSki);

			articles.add(new Combinaison(3, "Stypen", "PlumeS", "Combinaison Plume Stypen", 5.5f, 20, "jaune"));
			articles.add(
					new Combinaison(4, "Waterman", "WOBGreen", "Waterman Orion Bille vert", (float) 5.5, 20, "vert"));
			articles.add(new Combinaison(5, "Parker", "PlumeP", "Stylo Plume Parker", 5.5f, 5, "noir"));
